    ...
    if (name.includes('.')) {
      ...
      if (keys.length === 2) {
        setUser((prevUser) => ({
          ...prevUser,
          [keys[0]]: {
            ...(prevUser[keys[0] as keyof UserData] as object),
            [keys[1]]: value
          }
        }));
        ...
        setUser((prevUser) => ({
          ...prevUser,
          [keys[0]]: {
            ...(prevUser[keys[0] as keyof UserData] as any),
            [keys[1]]: {
              ...(prevUser[keys[0] as keyof UserData] as any)[keys[1]],
              [keys[2]]: value
            }
          }
        }));
    ...
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Address Information */}
          <h3 className="text-lg font-semibold text-gray-700 mb-3 mt-6">Address</h3>
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
          ...
          {/* Company Information */}
          <h3 className="text-lg font-semibold text-gray-700 mb-3 mt-6">Company</h3>
          <div className="mb-4">
